...
<html>
<head>
	<title>Gestión Privilegios - <?php echo $_SESSION['nombre']; ?></title>
                ...
                <div class="col s12 m12 l12">
                  ...
                  <ul id="projects-collection" class="collection z-depth-1">
                    <li class="collection-item avatar">
                      <i class="material-icons cyan circle">phonelink_lock</i>
                      <h6 class="collection-header m-0">Privilegios</h6>
                        ...
                        <form id="insertPrivilegios" >
                          ...
                          <div class="row">
                            <div class="input-field col s12 m12 l12 ">
                              <input id="txtRol" name="txtRol" type="text">
                          ...
                          <div class="row">
                            ...
                            <select id="txtEdicion" name="txtEdicion">
                              <option value="" disabled selected>Permiso Edición</option>
                            ...
                            <div class="input-field col s12">
                            <select id="txtEliminacion" name="txtEliminacion">
                              <option value="" disabled selected>Permiso Eliminación</option>
                              <option value="1">Si</option>
                              <option value="2">No</option>
                            </select>
                            <label>Materialize Select</label>
                          ...
                          <div class="input-field col s12">
                            <select id="txtBusqueda" name="txtBusqueda">
                              <option value="" disabled selected>Permiso Busqueda</option>
                              <option value="1">Si</option>
                              <option value="2">No</option>
                            </select>
                            <label>Materialize Select</label>
                          ...
                          <div class="input-field col s12">
                            <select id="txtActualizacion" name="txtActualizacion">
                              <option value="" disabled selected>Permiso Actualización</option>
                              <option value="1">Si</option>
                              <option value="2">No</option>
                            </select>
                            <label>Materialize Select</label>
...
`                   <li id="tablaPrivilegios1">
 ...
 <!-- Modal para actualizar inicio -->
                      <div id="modal2" class="modal">
                        <div class="modal-content">
                          <div class="col s12 m12 l12">
                            <h5>Editando Privilegio</h5>
                        <form id="actualizarPrivilegios" >
                          <input type="text" name="accionEjecutar" id="accionEjecutar2" value="2" style="display: none;">
                          <input type="text" name="idActualizar" id="idActualizar" value="" style="display: none;">
 
                          <div class="row">
                            <div class="input-field col s12 m12 l12 ">
                              <input id="modRol" name="modRol" type="text" autofocus>
                              <label for="first_name">Rol</label>
                            </div>
                          </div>
                          <div class="row">
                            ...
                            <div class="input-field col s12">
                            <select id="modEdicion" name="modEdicion" autofocus>
                              <option value="0" disabled>Permiso Edición</option>
                              <option value="1">Si</option>
                              <option value="2">No</option>
                            </select>
                            <label>Materialize Select</label>
                            ...
                            <div class="input-field col s12">
                            <select id="modEliminacion" name="modEliminacion" autofocus>
                              <option value="" disabled>Permiso Eliminación</option>
                              <option value="1">Si</option>
                              <option value="2">No</option>
                            </select>
                            <label>Materialize Select</label>
                          ...
                          <div class="input-field col s12">
                            <select id="modBusqueda" name="modBusqueda" autofocus>
                              <option value="0" disabled >Permiso Busqueda</option>
                              <option value="1">Si</option>
                              <option value="2">No</option>
                            </select>
                            <label>Materialize Select</label>
                          ...
                          <div class="input-field col s12">
                            <select id="modActualizacion" name="modActualizacion" autofocus>
                              <option value="0" disabled >Permiso Actualización</option>
                              <option value="1">Si</option>
                              <option value="2">No</option>
                            </select>
                            <label>Materialize Select</label>
...
<p id="uriEnviar" style="display: none;"><?php echo $_SESSION['uri']; ?></p>
  ...
  <script type="text/javascript">
    ...
    $('.modal-trigger').leanModal();
     ...
     //obtenemos datos de 
     rolEnviar= $("#rol"+idModificar).val();
     descripcionEnviar= $("#descripcion"+idModificar).val();
     edicionEnviar= $("#edicion"+idModificar).val();
     eliminacionEnviar= $("#eliminacion"+idModificar).val();
     busquedaEnviar= $("#busqueda"+idModificar).val();
     actualizarEnviar= $("#actualizar"+idModificar).val();

       
     //rellenar formulario para editar 
     $("#modRol").val(rolEnviar);
     $("#modDescripcion").val(descripcionEnviar);
    ...
    function tablaPrivilegios(){
      var tabla1= $.ajax({
        url: uri1+"controller/privilegiosC.php",
        dataType: "text",
        async: false

      }).responseText;
      document.getElementById('tablaPrivilegios1').innerHTML = tabla1;

    }
    setInterval(tablaPrivilegios,1000);
    ...
    function actualizaDatos(){
      ...
      var datosGuardar= $("#actualizarPrivilegios").serialize();
      //alert(datosGuardar);
      $.ajax({
        type: "POST",
        url: uri1+"controller/privilegiosC.php",
    ...
    function insertarDatos11(){
      ...
      var datosGuardar= $("#insertPrivilegios").serialize();
      //alert(datosGuardar);
      $.ajax({
        type: "POST",
        url: uri1+"controller/privilegiosC.php",
